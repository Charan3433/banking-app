...
const WithdrawPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.post('/api/transactions/withdraw', { account_id: Number(form.account_id), amount: Number(form.amount) }, { headers: { Authorization: `Bearer ${token}` } });
      ...
      <CardContent>
        ...
        <form onSubmit={handleSubmit}>
          <Stack spacing={2}>
            ...
            <Button variant="contained" type="submit">Withdraw</Button>
